    ...
    <div className="font-[Poppins]  bg-gray-900 h-screen">
      ...
      <div className=" grid grid-cols-3 gap-8 lg:mx-32 md:mx-8 xs:mx-auto my-4 bg-gray-900 justify-between">
        <div className="bg-white p-4 rounded-lg text-center ">
          <Link href={`/category/${getImageFileName("/images/gasoline.jpg")}`}>
            <Image
        ...
        <div className="bg-white p-4 rounded-lg text-center">
          <Link href={`/category/${getImageFileName("/images/electric.jpg")}`}>
            <Image
        ...
        <div className="bg-white p-4 rounded-lg text-center">
          <Link href={`/category/${getImageFileName("/images/pick-up.png")}`}>
            <Image
        ...
        <div className="bg-white p-4 rounded-lg text-center w-auto">
          <Link href={`/category/${getImageFileName("/images/hybrid.jpg")}`}>
            <Image
      ...
      <div className=" grid grid-cols-8 gap-8 lg:mx-32 md:mx-8 xs:mx-auto my-4 bg-gray-900 justify-between">
        ...
        <div className="bg-white p-4 rounded-lg text-center">
          <Link href={`/bodytype/${getImageFileName("/images/pick-up.svg")}`}>
            <Image
        ...
        <div className="bg-white p-4 rounded-lg text-center">
          <Link href={`/bodytype/${getImageFileName("/images/minivan.svg")}`}>
            <Image
